...
class NFAConstructionProblem extends LongKeyedMapper[NFAConstructionProblem] with IdPK with SpecificProblem[NFAConstructionProblem] {
  ...
  override def toXML(): Node = {
    return <NFAConstructionProblem>
             <Automaton>{ this.getAutomaton }</Automaton>
           </NFAConstructionProblem>
  }
}

object NFAConstructionProblem extends NFAConstructionProblem with SpecificProblemSingleton with LongKeyedMetaMapper[NFAConstructionProblem] {
