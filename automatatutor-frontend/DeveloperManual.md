...
In the /snippet/problems folder add a new file `<PN>Snippet.scala`. Here we implement the corresponding ProblemSnippet that needs to offer the 4 methods of the ProblemSnippet trait.
