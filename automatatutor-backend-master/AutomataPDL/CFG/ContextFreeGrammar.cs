...
namespace AutomataPDL.CFG
{
    ...
    public class ContextFreeGrammar
    {
        ...
        public Dictionary<Nonterminal, List<Production>> productionMap;

        private int emptyString = 0;
        public static int UNKOWN { get { return 0; } }
        public static int YES { get { return 1;  } }
        public static int NO { get { return 2; } }
        ...
        public void setAcceptanceForEmptyString(bool accepts)
        {
            if (accepts) emptyString = YES;
            else emptyString = NO;
        }

        public bool acceptsEmptyString()
        {
            if (emptyString == YES) return true;
            else if (emptyString == UNKOWN) {
                bool startIsNullable = GetNullables().Contains(startSymbol);
                setAcceptanceForEmptyString(startIsNullable);
                return startIsNullable;
            }
            return false;
        }
        ...
        public HashSet<Nonterminal> GetNullables()
        {
